...
<html>
    <head>
        ...
        <script src="js/asientos-diarios.js"></script>
	...
	<section class="container-fluid cabecera_oculta"></section>
		...
		<h4 class="titulo_ventana">Asiento de Diario</h4>
		...
		<table id="tabla_asientos" class="table table-bordered">
                    <thead>
                        <tr>
                            <th>Diario N°</th>
                            <th>Fecha</th>
        ...
        <input type="hidden" name="identificador_asiento" id="identificador_asiento" value="">
		...
		<div class="modal-content">
                    <form action="#" enctype="multipart/form-data" method="post" id="registro_asiento">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                        <h4 class="modal-title">Agregar Asiento de Diario</h4>
                    </div>
                    <div class="modal-body">
                        <div id="seccion1">
                        <div class="form-group col-md-5">
                            <label class="col-md-4">Diario N°:</label>
                            <div class="col-md-8">
                                <input type="text" class="form-control" id="numero_diario" name="numero_diario" required disabled>
                            </div>
                        </div>
                        <div class="col-md-2"></div>
                        <div class="form-group col-md-5 fecha_diario">
                            <label class="col-md-3">Fecha:</label>
                            <div class="input-group date col-md-9" id="datetimepicker1">
                                <input type='text' class="form-control" id='fecha_asiento' name='fecha_asiento' />
                        ...
                        <div class="form-group col-md-12">
                            ...
                            <div class="col-md-10 div_descripcion">
                            <textarea id="descripcion_asiento" name="descripcion_asiento" class="form-control" rows="2" required></textarea>
                            </div>
                        </div>
                        </div>
                        <div id="seccion2">
                        <button type="button" id="addRow" class="btn btn-default btn-xs">Agregar Fila</button>
                        <table id="registro_asientos_diarios" class="table table-striped" cellspacing="0">
                            <thead>
                                <tr>
                                    <th>Cuenta</th>
                                    <th>Nombre Cuenta</th>
                    ...
                    <div class="modal-footer">
                        <button type="submit" class="btn btn-primary btn_agregar_asiento" disabled="disable">Agregar</button>
                        <button type="button" class="btn btn-primary" id="imprimir_asiento">Imprimir</button>
