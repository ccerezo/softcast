...
<html>
    <head>
        <title>Bancos - Despósito Bancario</title>
        ...
        <script src="js/deposito-bancario.js"></script>
	...
	<section class="container-fluid cabecera_oculta"></section>
		...
		<h4 class="titulo_ventana">Depósito Bancario</h4>
		...
		<table id="tabla_depositos" class="table table-bordered">
                    <thead>
                        <tr>
                            <th>Depósito N°</th>
                            <th>Fecha</th>
		...
		<div class="modal-content">
                    ...
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title">Depósito Bancario: <span id="numero_diario"></span></h4>
                    </div>
                    <div class="modal-body">
                        ...
                        <div class="panel panel-default mi_panel">
                            <div class="panel-heading">
                                <h4 class="panel-title">Datos del Depósito</h4>
                            </div>
                            <div class="panel-body">
