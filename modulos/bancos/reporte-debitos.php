 ...
 */
    ...
    $id = $_GET['id'];
    $query = "select nd.deb_numdebito numero, nd.deb_fecha fecha, nd.deb_descripcion descripcion, dad.cont_detalle_descripcion descripcion_detalle, 
            ...
            inner join cont_detalle_asiento_diario dad on nd.deb_numdebito = dad.cont_num_asiento_detalle 
...
$html.='<html>
	...
	<body>
            ...
            <h3 class="titulo">Comprobante de Nota de Débito N° '.$numero.'</h3>
...
require_once("../../../dyansoft/dompdf/dompdf_config.inc.php");
    ...
    echo $pdf->output('Nota de Débito.pdf'); //Y con ésto se manda a imprimir el contenido del pdf
