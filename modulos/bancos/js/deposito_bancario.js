         ...
         $.ajax({
                ...
                success: function(data){
                    ...
                    if(data!=='fallo'){
                        ...
                        bootbox.alert({
                            title: "Informaci�n",
                            message: "El dep�sito se agreg� Correctamente! ",
                            buttons: {
                                'ok': {
                                    label: 'Aceptar',
                            ...
                            callback: function() {
                               ...
                               $(".selectpicker").attr('disabled', true);
                                   $("#identificador_deposito").val(response[0]["id_deposito"]);
                            }
                        });
                    }else{
                        bootbox.alert({
                            title: "Informaci�n",
                            message: "El dep�sito no se agreg� Revise los datos y vuelva a intentar!",
                            buttons: {
                                'ok': {
                                    label: 'Aceptar',
...
/** El datepicker lo escribe en idioma espa�ol*/
 ...
 dayNames: ['Domingo', 'Lunes', 'Martes', 'Mi�rcoles', 'Jueves', 'Viernes', 'Ssbado'],
...
//Fin del document ready
  ...
  function ver_deposito(id){ 
    ...
    url = "reporte_depositos.php?id="+id;
    var w = 850;
    var h = 550;
    ...
    var WindowObject = window.open(url,"Reporte Dep�sito","width="+w+",height="+h+",scrollbars=yes,top="+y+", left="+x+"") 
    WindowObject.document.title = "Reporte Dep�sito";
}
