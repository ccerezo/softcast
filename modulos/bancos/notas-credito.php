...
<html>
    <head>
        ...
        <script src="js/notas_credito.js"></script>
	...
	<section class="container-fluid cabecera_oculta"></section>
		...
		<h4 class="titulo_ventana">Notas de Crédito</h4>
		...
		<table id="tabla_credito" class="table table-bordered">
                    <thead>
                        <tr>
                            <th>Crédito N°</th>
                            <th>Fecha</th>
		...
		<div class="modal-content">
                    ...
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title">Nota de Crédito: <span id="numero_diario"></span></h4>
                    </div>
                    <div class="modal-body">
                        ...
                        <div class="panel panel-default mi_panel">
                            <div class="panel-heading">
                                <h4 class="panel-title">Datos de la Nota de Crédito</h4>
                            </div>
                            <div class="panel-body">
