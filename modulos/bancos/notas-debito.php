...
<html>
    <head>
        <title>Bancos - Notas de Débito</title>
        ...
        <script src="js/notas-debito.js"></script>
	...
	<section class="container-fluid cabecera_oculta"></section>
		...
		<h4 class="titulo_ventana">Notas de Débito</h4>
		...
		<table id="tabla_debito" class="table table-bordered">
                    <thead>
                        <tr>
                            <th>Débito N°</th>
                            <th>Fecha</th>
		...
		<div class="modal-content">
                    ...
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title">Nota de Débito: <span id="numero_diario"></span></h4>
                    </div>
                    <div class="modal-body">
                        ...
                        <div class="panel panel-default mi_panel">
                            <div class="panel-heading">
                                <h4 class="panel-title">Datos de la Nota de Débito</h4>
                            </div>
                            <div class="panel-body">
