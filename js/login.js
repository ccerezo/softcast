			...
			$.ajax({
				...
				success: function(data){
					...
					if(response["estado"] == "404"){
						...
						$("#usuario_sesion").val("");
						$("#clave_sesion").val("");
						window.location.href = "http://localhost/softcast/sistema.php";
						/*var caracteristicas = "height=700,width=1366,scrollTo,resizable=1,scrollbars=1,location=0";
						window.open('http://localhost/dyansoft/sistema.php','Popup', caracteristicas);*/
